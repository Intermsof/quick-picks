...
class LoginEmail: UIViewController {
    ...
    static let headerHeightPercentageFromTop : CGFloat = 0.125 //Percentage of the screen height to offset the header from top of view
    ...
    override func viewDidLoad() {
        ...
        let descriptionView = images.1
        LoginOptions.addRadialLayer(view: container)
        
        let emailTextField = LoginTextField.buildLoginTextFieldWith(type: .email, validate: false)
        ...
        let passwordTextField = LoginTextField.buildLoginTextFieldWith(type: .password, validate: false)
